...
const SubCheckout: FC<PageProps> = ({ params }) => {
  ...
  if (sub && sub.set_and_forget_sub_upgrade) {
    total += constants.saf_subscriptions.PRO;
  }
  if (sub && sub.set_and_forget_sub) {
    total += constants.saf_subscriptions.BASIC;
  }
            ...
            <div className="em__flex">
              ...
              <div className="checkout__total">
                ...
                <div className="cart__total">
                  {sub.set_and_forget_sub && (
                    <div className="em__flex">
                      <h4>Set and Forget Subscription</h4>
                      <span>
                        {formattedMoney(constants.saf_subscriptions.BASIC)}{" "}
                      </span>
                    </div>
                  )}

                  {sub.set_and_forget_sub_upgrade && (
                    <div className="em__flex">
                      <h4>Set and Forget upgrade</h4>
                      <span>
                        {formattedMoney(constants.saf_subscriptions.PRO)}{" "}
                      </span>
                    </div>
                  )}
                  <hr />
