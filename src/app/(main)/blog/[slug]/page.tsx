            ...
            <div className="em__blog__body">
              <div className="em__blog_main">
                <div className="em__latest__blog_card">
                  <div className="top__details">
                    ...
                    <div className="title">
                      <h2>
                        ...
                        sea rching for a location for your event.
                      </h2>
                    </div>
                  </div>
                  ...
                  <div className="details blog__details">
                    <p>
                      Don’t waste another day endlessly scrolling social media
                    ...
                    <p>
                      New Hampshire can be daunting! Choosing the right place
                      can be the difference between simply having a ‘nice’
                      event.Don’t waste another day endlessly scrolling social
                      media searching for a location for your event. The truth
                      is, researching the vast amount of venue options in New
                      Hampshire can be daunting! Choosing the right place can be
                      the difference between simply having a ‘nice’ event.
                    </p>

                    <div className="em__audio__embedded">
                      <button>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          xmlnsXlink="http://www.w3.org/1999/xlink"
